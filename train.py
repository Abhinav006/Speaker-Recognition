...
class Training_file:
    def __init__(self):
        ...
        global v2
        v2 = StringVar()
        user_entry = self.EntryWithPlaceholder(root, "Duration(Optional)","black",textvariable = v2)
        ...
        train_button = Button(root, text="Train", bd=0, bg="black", fg="white", font=("Courier",25))
