...
class Testing_file:
    def __init__(self):
        ...
        image = Image.open(r'bggif/1.gif')
        ...
        recording_button.place(relx=0.5, rely=0.4, anchor=CENTER)
        ...
        test_button = Button(root, text="Test", bd=0, bg="black", fg="green", font=("Courier",35))
