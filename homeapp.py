...
test_button = Button(root, fg="white", background="green", activebackground="green",font=("Helvetica",20,'bold italic'), activeforeground="orange", text='Test the machine', padx=10, pady=10, command = testing)
test_button.place(relx=0.7, rely=0.1, anchor=CENTER)

quit = Button(root, fg="white", background="green", activebackground="green",font=("Helvetica",20,'bold italic'), activeforeground="orange", text="Quit", command=root.destroy, padx=10, pady=10)
